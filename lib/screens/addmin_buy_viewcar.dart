...
import 'package:carmarketplace/screens/edit_buy_car.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';

class admin_buy_ViewCarPage extends StatefulWidget {
  const admin_buy_ViewCarPage({super.key});

  @override
  State<admin_buy_ViewCarPage> createState() => _ViewCarPageState();
}

class _ViewCarPageState extends State<admin_buy_ViewCarPage> {
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => Edit_buy_CarPage(
                                            docId: docId,
                                            carData: car,
                                          ),
                                        ),
